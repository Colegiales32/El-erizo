...
const Eventos = () => {
  ...
  return (
    <div  className="mt-5 md:mt-8 mx-[1.2rem] md:mx-[7.2rem] 2xl:max-w-[75rem] 2xl:mx-auto">
        <h3 ref={eventosRef[0]} className='fade-in-up-scroll font-calibri font-medium text-oscuro text-[1.6rem] w-fit'>Nuestros Eventos</h3>
      <div ref={eventosRef[1]} className='fade-in-up-scroll mt-5 md:mt-8 flex flex-col lg:flex-row justify-between mx-[1.2rem] items-center md:mx-auto max-w-[75rem] gap-4'>
        <Cards 
        imagen="/evento3.webp"
