...
const Nav = () => {
    ...
    const handleLinkClick = (linkName) => {
        setActiveLink(linkName); // Establece el enlace activo al hacer clic
        setTimeout(() => {
            setClicked(false)
        }, 300);
    };
    ...
    return (
        <nav className="fixed top-0 w-full z-50 h-24 sombra flex items-center bg-rosa-claro">
            <div className="lg:mx-16 mx-5 w-full flex flex-row justify-between selection:bg-celeste">
                ...
                <div className="lg:flex hidden flex-row items-center gap-7 text-lg">
                <a
                        href="#inicio"
                    ...
                    <a
                        href="#taller"
                        onClick={() => handleLinkClick('El taller')}
                        className={activeLink === 'El taller' ? 'link-active' : ''}
                    >
                        El taller
                    </a>
                    <a
...
<rect width="32" height="32" fill="white" transform="translate(0.5)"/>
                ...
                <div className={`links bg-right-top bg-cover bg-no-repeat justify-between flex flex-col gap-9 items-center lg:hidden ${clicked ? 'active' : ''}`}>
