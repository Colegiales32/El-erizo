...
const Nosotros = () => {
  return (
    <div className="flex mt-5 md:mt-8 flex-col-reverse lg:flex-row mx-[1.2rem] md:mx-[7.2rem] gap-[1.25rem] justify-between 2xl:mx-[22rem] xl:justify-center 2xl:gap-8 ">
        <div className="w-full sombra h-full lg:max-w-[36rem] lg:min-w-[25rem] overflow-hidden rounded-[10px]">
            <img className='aspect-square lg:aspect-video w-full h-[20rem] object-cover' src="./public/nosotros.jpeg" alt="imagen del curso" />
        </div>
        <div className='my-auto max-w-xl text-sm md:text-xl leading-7 md:leading-9 font-light'>
