...
const Cursos = () => {
  return (
    <div class="h-auto selection:bg-celeste mt-5 mb-16 md:mb-24 md:mt-8 md:h-min-[14rem] lg:h-[14rem] font-calibri p-[1rem] bg-[#FCDED3] rounded-[10px] mx-[1.2rem] md:mx-[6rem] xl:mx-[22rem] 2xl:mx-[32rem] flex flex-col md:flex-row gap-5 justify-between items-center sombra">
        <div className="w-full h-full md:max-w-[14rem] md:min-w-[14rem]  overflow-hidden rounded-[10px]">
            <img className=' aspect-square w-full object-cover' src="./public/imagen-curso.jpg" alt="imagen del curso" />
        </div>
